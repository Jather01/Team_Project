...
<div class="container">
	...
	<form action="update.do" method="post">
		...
		<div>
			<label for="email">주소1</label>
			<input type="text" id="addr1" name="addr1" value="${dto.addr1 }"/>
		</div>
		<div>
			<label for="email">주소2</label>
			<input type="text" id="addr2" name="addr2" value="${dto.addr2 }"/>
		</div>
		<div>
			<label for="email">주소3</label>
			<input type="text" id="addr3" name="addr3" value="${dto.addr3 }"/>
		</div>
